...
$query = "SELECT Id,FirstName,LastName,Email FROM _Author WHERE Id=:id;
		  ...
		  SELECT Id,CategoryName FROM _Category AS c INNER JOIN _Book_Category AS bc ON c.Id = bc.Category INNER JOIN _Author_Book AS ab ON ab.Book = b.Id AND b.Id = bc.Book WHERE ab.Author=:id";
